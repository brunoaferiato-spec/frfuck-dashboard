...
export const regrasGravatai: RegrasVendedorMecanico = {
  vendedor: {
...
export const regraAlinhadorGravatai: RegraAlinhador = {
...
export const regrasConsultorGravatai: RegrasConsultor = {
  meta1: {
    periodicidade: "semanal",
...
export const regrasRecepcaoGravatai: RegrasRecepcao = {
  regraPadrao: {
    valorVenda: 1.5,
    valorEntrada: 0,
  },
